...
from rlinf_rollout.envs.realworld.dosw1.tasks.pick import PickEnv as PickEnv
...
register(
    id="DOSW1PickEnv-v1",
    entry_point="rlinf_rollout.envs.realworld.dosw1.tasks:create_dosw1_pick_env",
)
