...
from rlinf_rollout.envs.realworld.common.camera import (
    BaseCamera,
    CameraInfo,
    create_camera,
)
from rlinf_rollout.envs.realworld.common.video_player import VideoPlayer
...
class FrankaEnv(gym.Env):
    ...
    def _setup_reward_worker(self):
        ...
        # TODO(agent): the standalone realworld reward worker is vendored in a
        # later phase (it needs the FSDP model manager + reward datasets). Until
        # then this lazy import only resolves when that module is provided.
        from rlinf_rollout.workers.reward.reward_worker import EmbodiedRewardWorker
