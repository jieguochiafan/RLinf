...
from rlinf_rollout.scheduler import Cluster, NodePlacementStrategy, Worker
...
class FrankaController(Worker):
    ...
    def __init__(
        ...
        from rlinf_rollout.envs.realworld.common.ros import ROSController
    ...
    def _init_end_effector(
        ...
        if self._end_effector_type.is_gripper:
            from rlinf_rollout.envs.realworld.common.gripper import create_gripper
