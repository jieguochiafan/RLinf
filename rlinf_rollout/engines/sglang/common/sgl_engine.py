...
Patcher.add_patch(
    ...
    "rlinf_rollout.engines.sglang.common.sgl_engine._set_envs_and_config",
)
Patcher.add_patch(
    "sglang.srt.managers.tokenizer_manager.TokenizerManager",
    "rlinf_rollout.engines.sglang.common.tokenizer_manager.TokenizerManager",
)
...
if sglang_version <= parse("0.5.5"):
    Patcher.add_patch(
        ...
        "rlinf_rollout.engines.sglang.common.detokenizer_manager.DetokenizerManager",
    )
    Patcher.add_patch(
        "sglang.srt.managers.detokenizer_manager.run_detokenizer_process",
        "rlinf_rollout.engines.sglang.common.detokenizer_manager.run_detokenizer_process",
    )

Patcher.add_patch(
    "sglang.srt.managers.scheduler.run_scheduler_process",
    "rlinf_rollout.engines.sglang.common.sgl_scheduler.run_scheduler_process",
)
Patcher.apply()
