...
class ClusterConfig:
    ...
    For component placement format, refer to `rlinf_rollout.scheduler.placement.component_placement`. Here is the detailed specification of the node group configuration.
