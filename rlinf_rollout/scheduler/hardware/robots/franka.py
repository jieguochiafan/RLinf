...
class FrankaRobot(Hardware):
    ...
    def enumerate_cameras(cls, camera_type: str = "realsense") -> set[str]:
        ...
        if ct == "zed":
            ...
            # TODO(agent): Phase 2 vendors rlinf_rollout.envs; until then Lumos
            # camera discovery raises ModuleNotFoundError.
            from rlinf_rollout.envs.realworld.common.camera.lumos_camera import (
                LumosCamera,
            )
