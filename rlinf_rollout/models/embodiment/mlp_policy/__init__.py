...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    from rlinf_rollout.models.embodiment.mlp_policy.iql_mlp_policy import IQLMLPPolicy
    from rlinf_rollout.models.embodiment.mlp_policy.mlp_policy import MLPPolicy
    from rlinf_rollout.models.embodiment.mlp_policy.rlt_mlp_policy import RLTMLPPolicy
