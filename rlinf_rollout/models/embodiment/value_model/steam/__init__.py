...
:func:`rlinf_rollout.models.embodiment.value_model.recap.get_model` so the router in
...
def get_model(
    ...
    Signature matches :func:`rlinf_rollout.models.embodiment.value_model.recap.get_model`
