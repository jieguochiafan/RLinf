...
:func:`rlinf_rollout.models.embodiment.openpi_pytorch.get_model` loads the vendored
...
def _build_eval_model(
    ...
    *,
    ...
    from rlinf_rollout.models.embodiment.openpi_pytorch.transforms_pipeline import (
...
def _build_sft_model(
    ...
    *,
    ...
    """
    from rlinf_rollout.models.embodiment.openpi_pytorch.sft_action_model import (
...
def _build_rl_model(
    ...
    *,
    ...
    from rlinf_rollout.models.embodiment.openpi_pytorch.rl_action_model import (
