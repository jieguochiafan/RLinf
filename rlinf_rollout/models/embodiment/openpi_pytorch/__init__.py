...
def get_model(cfg: Any, torch_dtype: Any = None) -> Any:
    ...
    from rlinf_rollout.models.embodiment.openpi_pytorch.pi0_model.pi0_config import (
        Pi0Config,
    )
    from rlinf_rollout.models.embodiment.openpi_pytorch.utils.model_builders import (
        _build_eval_model,
        _build_rl_model,
        _build_sft_model,
    )
