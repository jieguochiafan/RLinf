...
from rlinf_rollout.data.datasets.dreamzero.data_transforms import (
    build_dreamzero_composed_transform,
    load_dreamzero_dataset_metadata,
)
from rlinf_rollout.models.embodiment.dreamzero.dreamzero_config import DreamZeroConfig
from rlinf_rollout.models.embodiment.dreamzero.dreamzero_policy import DreamZeroPolicy
...
def get_model(cfg: DictConfig, torch_dtype=None):
    ...
    Patcher.add_patch(
        ...
        "rlinf_rollout.models.embodiment.dreamzero.patch.wan_video_vae.WanVideoVAE",
    )
    Patcher.add_patch(
        "groot.vla.model.dreamzero.modules.wan_video_vae.WanVideoVAE38",
        "rlinf_rollout.models.embodiment.dreamzero.patch.wan_video_vae.WanVideoVAE38",
    )
    Patcher.add_patch(
        "groot.vla.model.dreamzero.modules.wan_video_vae.WanVideoVAEStateDictConverter",
        "rlinf_rollout.models.embodiment.dreamzero.patch.wan_video_vae.WanVideoVAEStateDictConverter",
    )
    ...
    Patcher.add_patch(
        ...
        "rlinf_rollout.models.embodiment.dreamzero.patch.wan_causal_model_forward_train._forward_train",
    )
    Patcher.add_patch(
        "groot.vla.data.schema.embodiment_tags.EmbodimentTag",
        "rlinf_rollout.data.datasets.dreamzero.data_transforms.embodiment_tag.EmbodimentTag",
    )
    Patcher.apply()
