...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    if model_type == "gr00t_n1d7":
        from rlinf_rollout.models.embodiment.gr00t.gr00t_n1d7 import (
            get_model as get_model_n1d7,
        )

        return get_model_n1d7(cfg, torch_dtype)

    if model_type == "gr00t_n1d6":
        from rlinf_rollout.models.embodiment.gr00t.gr00t_n1d6 import (
            get_model as get_model_n1d6,
        )

        return get_model_n1d6(cfg, torch_dtype)

    if model_type in ("gr00t", "gr00t_n1d5"):
        from rlinf_rollout.models.embodiment.gr00t.gr00t_n1d5 import (
            get_model as get_model_n1d5,
        )
