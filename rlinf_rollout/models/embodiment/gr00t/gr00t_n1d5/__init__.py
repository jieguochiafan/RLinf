...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    Patcher.add_patch(
        ...
        "rlinf_rollout.models.embodiment.gr00t.embodiment_tags.EmbodimentTag",
    )
    Patcher.add_patch(
        "gr00t.data.embodiment_tags.EMBODIMENT_TAG_MAPPING",
        "rlinf_rollout.models.embodiment.gr00t.embodiment_tags.EMBODIMENT_TAG_MAPPING",
    )
    ...
    try:
        ...
        from rlinf_rollout.models.embodiment.gr00t.gr00t_n1d5.gr00t_action_model import (
            GR00T_N1_5_ForRLActionPrediction,
        )
        from rlinf_rollout.models.embodiment.gr00t.utils import (
        ...
        if (
            ...
            data_config = load_data_config(
                "rlinf_rollout.models.embodiment.gr00t.gr00t_n1d5.modality_config:LiberoFrankaDataConfig"
            )
        elif cfg.embodiment_tag == "maniskill_widowx":
            data_config = load_data_config(
                "rlinf_rollout.models.embodiment.gr00t.gr00t_n1d5.modality_config:ManiskillWidowXDataConfig"
            )
        else:
