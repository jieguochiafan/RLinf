...
def get_model_config_and_input_processor(cfg: DictConfig):
    ...
    from rlinf_rollout.models.embodiment.prismatic.processing_prismatic import (
...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    from rlinf_rollout.models.embodiment.openvla_oft.rlinf.openvla_oft_action_model import (
