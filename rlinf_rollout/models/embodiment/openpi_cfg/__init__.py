...
def get_model(cfg: DictConfig, torch_dtype=None):
    ...
    from rlinf_rollout.models.embodiment.openpi.dataconfig import get_openpi_config
    from rlinf_rollout.models.embodiment.openpi_cfg.openpi_cfg_action_model import (
        OpenPi0Config,
