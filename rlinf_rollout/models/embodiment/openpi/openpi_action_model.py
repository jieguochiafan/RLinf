...
from rlinf_rollout.models.embodiment.base_policy import BasePolicy, ForwardType
from rlinf_rollout.models.embodiment.modules.explore_noise_net import ExploreNoiseNet
from rlinf_rollout.models.embodiment.modules.value_head import ValueHead
from rlinf_rollout.utils.logging import get_logger
from rlinf_rollout.utils.nested_dict_process import copy_dict_tensor
from rlinf_rollout.utils.pytree import register_pytree_dataclasses
...
class OpenPi0ForRLActionPrediction(PI0Pytorch, BasePolicy):
    ...
    def __init__(
        ...
        if self.config.use_rlt:
            from rlinf_rollout.models.embodiment.modules.rlt_token_transformer import (
                RLTTokenTransformer,
            )
        ...
        if self.config.use_dsrl:
            from rlinf_rollout.models.embodiment.modules.compact_encoders import (
                CompactMultiQHead,
                CompactStateEncoder,
                LightweightImageEncoder64,
            )
            from rlinf_rollout.models.embodiment.modules.gaussian_policy import (
                GaussianPolicy,
            )
